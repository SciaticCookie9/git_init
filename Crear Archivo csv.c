...
int main(){
	...
	for(i=1; i<=3; i++){
		...
		scanf("%d", &calificacion[i].parcial1);
		printf("Ingrese la calificacion del segundo parcial: \n");
		scanf("%d", &calificacion[i].parcial2);
		printf("Ingrese la calificacion del pia: \n");
		scanf("%d", &calificacion[i].pia);
		calificacion[i].califinal=(calificacion[i].parcial1+calificacion[i].parcial2+calificacion[i].pia)/3;
		system("cls");
	}
	fflush(ar);
	for(i=1; i<=3; i++){
		fprintf( ar , "%d, %d, %d, %d, %.2f\n", calificacion[i].matricula, calificacion[i].parcial1, calificacion[i].parcial2, calificacion[i].pia, calificacion[i].califinal);
	} 
